public abstract class Animal implements Singing, Bio {
    ...
    public String toString() {
        return "Old MacDonald had a farm. " +
                ...
                ". E-I-E-I-O. With a " + this.getSound() + " " + this.getSound() +
                " here. And a " + this.getSound() + " " + this.getSound() +
                " there. Here a " + this.getSound() + ". There a " + this.getSound() +
                ". Everywhere a " + this.getSound() + " " + this.getSound() +
